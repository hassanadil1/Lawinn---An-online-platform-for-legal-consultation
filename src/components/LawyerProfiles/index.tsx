  ...
  return (
    <div className="mt-32 max-w-md w-full  mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black">
      ...
      <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300">
        Add the following details. Others who are interested in your services will be able to see this.
      </p>
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <LabelInputContainer className="mb-4">
          <Label htmlFor="email">Field Of Expertise</Label>
          <Input id="text" placeholder=" Qabza Party" type="email" />
        </LabelInputContainer>

        <LabelInputContainer className="mb-4">
          <Label htmlFor="experience">Experience</Label>
          <Input id="text" placeholder="Waduu" type="password" />
        </LabelInputContainer>

        <LabelInputContainer className="mb-4">
          <Label htmlFor="designation">Civil, Criminal or Corporate?</Label>
